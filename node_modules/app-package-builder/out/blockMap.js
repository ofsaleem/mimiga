...
exports.computeBlockMap = exports.createPackageFileInfo = exports.createDifferentialPackage = exports.createDifferentialFile = undefined;
...
let createDifferentialFile = exports.createDifferentialFile = (() => {
    var _ref = (0, (_bluebirdLst || _load_bluebirdLst()).coroutine)(function* (file, isAppendToFile = false) {
        const fd = yield (0, (_fsExtraP || _load_fsExtraP()).open)(file, isAppendToFile ? "a+" : "r");
        try {
            let fileSize = (yield (0, (_fsExtraP || _load_fsExtraP()).stat)(file)).size;
            ...
            const blockMapFileData = yield serializeBlockMap(blockMap, file, !isAppendToFile);
            if (isAppendToFile) {
                fileSize += yield appendBlockMapData(fd, blockMapFileData, true);
            }
            return yield createFileInfo(blockMapFileData, file, fileSize);
        } catch (e) {
            yield (0, (_fsExtraP || _load_fsExtraP()).close)(fd);
            throw e;
        }
    ...
    return function createDifferentialFile(_x) {
        return _ref.apply(this, arguments);
    };
})();

let createDifferentialPackage = exports.createDifferentialPackage = (() => {
    var _ref2 = (0, (_bluebirdLst || _load_bluebirdLst()).coroutine)(function* (archiveFile) {
    ...
    return function createDifferentialPackage(_x2) {
        return _ref2.apply(this, arguments);
    };
})();

let serializeBlockMap = (() => {
    var _ref3 = (0, (_bluebirdLst || _load_bluebirdLst()).coroutine)(function* (blockMap, file, isUseGzip) {
    ...
    return function serializeBlockMap(_x3, _x4, _x5) {
        return _ref3.apply(this, arguments);
    };
})();

let appendBlockMapData = (() => {
    var _ref4 = (0, (_bluebirdLst || _load_bluebirdLst()).coroutine)(function* (fd, blockMapFileData, addLength) {
    ...
    return function appendBlockMapData(_x6, _x7, _x8) {
        return _ref4.apply(this, arguments);
    };
})();

let createFileInfo = (() => {
    var _ref5 = (0, (_bluebirdLst || _load_bluebirdLst()).coroutine)(function* (blockMapData, file, fileSize) {
        return {
            path: file,
            size: fileSize,
    ...
    return function createFileInfo(_x9, _x10, _x11) {
        return _ref5.apply(this, arguments);
    };
})();

let createPackageFileInfo = exports.createPackageFileInfo = (() => {
    var _ref6 = (0, (_bluebirdLst || _load_bluebirdLst()).coroutine)(function* (file, blockMapSize) {
        return {
            path: file,
    ...
    return function createPackageFileInfo(_x12, _x13) {
        return _ref6.apply(this, arguments);
    };
})();

let computeBlockMap = exports.computeBlockMap = (() => {
    var _ref7 = (0, (_bluebirdLst || _load_bluebirdLst()).coroutine)(function* (sevenZFile) {
    ...
    return function computeBlockMap(_x14) {
        return _ref7.apply(this, arguments);
    };
})();

let doComputeBlockMap = (() => {
    var _ref8 = (0, (_bluebirdLst || _load_bluebirdLst()).coroutine)(function* (files, fd) {
    ...
    return function doComputeBlockMap(_x15, _x16) {
