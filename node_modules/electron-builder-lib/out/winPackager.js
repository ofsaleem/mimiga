...
class WinPackager extends (_platformPackager || _load_platformPackager()).PlatformPackager {
    ...
    signApp(packContext) {
        ...
        return (0, (_bluebirdLst || _load_bluebirdLst()).coroutine)(function* () {
            const exeFileName = `${_this7.appInfo.productFilename}.exe`;
            if (_this7.platformSpecificBuildOptions.signAndEditExecutable !== false) {
                yield _this7.signAndEditResources(_path.join(packContext.appOutDir, exeFileName), packContext.arch, packContext.outDir, _path.basename(exeFileName, ".exe"), _this7.platformSpecificBuildOptions.requestedExecutionLevel);
            }
        })();
    }
}
