...
class RemoteTarget extends (_core || _load_core()).Target {
    ...
    build(appOutDir, arch) {
        ...
        return (0, (_bluebirdLst || _load_bluebirdLst()).coroutine)(function* () {
            (0, (_builderUtil || _load_builderUtil()).log)(`Schedule remote ${_this.target.name} build for arch ${(_builderUtil || _load_builderUtil()).Arch[arch]}`);
            yield _this.target.checkOptions();
            _this.remoteBuilder.scheduleBuild(_this.target, arch, appOutDir);
        })();
    }
}
